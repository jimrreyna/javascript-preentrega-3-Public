...
const producto8 = new Producto(8, "Memoria DDR4 16GB", 90,"./img/memoria16.jpg");
const producto9 = new Producto(9, "Case Gamer Hallion", 80,"./img/casegamer.jpg");
const producto10 = new Producto(10, "Disco SSD 480GB", 100,"./img/disco480.jpg");
